...
namespace TalesFromTheRift
{
	public class CanvasKeyboardASCII : MonoBehaviour 
	{
		...
		{
			alphaBoardUnsfhifted.SetActive(false);
			alphaBoardSfhifted.SetActive(false);
			numberBoardUnshifted.SetActive(false);
			numberBoardShifted.SetActive(false);
			numberBoardUnshifted.SetActive(true);
		}
